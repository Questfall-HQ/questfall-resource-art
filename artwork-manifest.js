...
export const artwork = Object.freeze({
  ...
  slot_head: {group: 'slot', name: 'head', source: 'sources/slots/head.png', output: 'slots/v2/head'},
  slot_chest: {group: 'slot', name: 'chest', source: 'sources/slots/chest.png', output: 'slots/v2/chest'},
  slot_hands: {group: 'slot', name: 'hands', source: 'sources/slots/hands.png', output: 'slots/v2/hands'},
  slot_legs: {group: 'slot', name: 'legs', source: 'sources/slots/legs.png', output: 'slots/v2/legs'},
  slot_feet: {group: 'slot', name: 'feet', source: 'sources/slots/feet.png', output: 'slots/v2/feet'},
  slot_outer: {group: 'slot', name: 'outer', source: 'sources/slots/outer.png', output: 'slots/v2/outer'},
  slot_potion: {group: 'slot', name: 'potion', source: 'sources/slots/potion.png', output: 'slots/v2/potion'},
