...
export const artwork = Object.freeze({
  ...
  slot_head: {group: 'slot', name: 'head', source: 'sources/slots/head.png', sources: {tiny: 'sources/slots/tiny/head.png'}, output: 'slots/v3/head'},
  slot_chest: {group: 'slot', name: 'chest', source: 'sources/slots/chest.png', sources: {tiny: 'sources/slots/tiny/chest.png'}, output: 'slots/v3/chest'},
  slot_hands: {group: 'slot', name: 'hands', source: 'sources/slots/hands.png', sources: {tiny: 'sources/slots/tiny/hands.png'}, output: 'slots/v3/hands'},
  slot_legs: {group: 'slot', name: 'legs', source: 'sources/slots/legs.png', sources: {tiny: 'sources/slots/tiny/legs.png'}, output: 'slots/v3/legs'},
  slot_feet: {group: 'slot', name: 'feet', source: 'sources/slots/feet.png', sources: {tiny: 'sources/slots/tiny/feet.png'}, output: 'slots/v3/feet'},
  slot_outer: {group: 'slot', name: 'outer', source: 'sources/slots/outer.png', sources: {tiny: 'sources/slots/tiny/outer.png'}, output: 'slots/v3/outer'},
  slot_potion: {group: 'slot', name: 'potion', source: 'sources/slots/potion.png', sources: {tiny: 'sources/slots/tiny/potion.png'}, output: 'slots/v3/potion'},
